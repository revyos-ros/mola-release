...
Name:           ros-jazzy-mola-input-kitti-dataset
Version:        1.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS mola_input_kitti_dataset package

License:        GPLv3
URL:            https://github.com/MOLAorg/mola/tree/develop/mola_input_kitti_dataset
