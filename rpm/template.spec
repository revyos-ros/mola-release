...
Name:           ros-jazzy-mola-input-mulran-dataset
Version:        1.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS mola_input_mulran_dataset package

License:        GPLv3
URL:            https://github.com/MOLAorg/mola/tree/develop/mola_input_mulran_dataset
